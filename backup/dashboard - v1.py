...
with col1:
    # st.header("University Faculty Distribution")
...
with col4:
    ...
    selected_professor = st.selectbox("Select a professor", professors,
                                      index=professors.tolist().index("Kevin Chenchuan Chang"))
    ...
    """
    prof_info = mysql_query(query).iloc[0]
...
with col5:
    ...
    selected_professor1 = st.selectbox("Select a university", professors,
                                       index=professors.tolist().index("Kevin Chenchuan Chang"), 
